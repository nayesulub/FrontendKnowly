...
import { LayoutDashboard,BookText,BookOpen,Calculator,Landmark,Beaker,Atom,Globe,Monitor,LockKeyhole,ChevronRight, AlertTriangle, X, Info, Crown, Star, Shield, User, LogOut, Rocket, TrendingUp, Search, Coins  } from 'lucide-react';

export function Asignaturasp() {
  ...
  const subjectCategories = [
    {
      ...
      subjects: [
        ...
        },
        {
          ...
          color: '#5BA7F7',
          description: 'Domina la conjugación verbal con este quiz divertido',
          ageRange: '6-12 años',
          locked: false
        }
      ]
                ...
                {category.subjects.map((subject, index) => (
                  <SubjectCard key={index}>
                    ...
                    {subject.locked ? (
                      ...
                      <CourseButton
                        locked={false}
                        onClick={() => navigate('/EjerciciosPreguntas')}
                      >
                        <span>Unirme</span>
