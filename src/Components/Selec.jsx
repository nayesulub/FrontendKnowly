...
export function Selec() {
  ...
  const handleActivityClick = (activity) => {
    if (activity.locked) {
      ...
      // Redirigir a la página de ejercicios o donde corresponda
      navigate('/Ejercicios');
    }
  };
                ...
                {category.activities.map((activity, index) => (
                  <ActivityCard key={index}>
                    <ActivityImageContainer>
                      {/* Puedes usar la imagen o el ícono como fallback */}
                      <ActivityImage 
                        imageUrl={activity.imageUrl} 
                        color={activity.color}
                      >
                        {/* Ícono grande como placeholder o decoración */}
